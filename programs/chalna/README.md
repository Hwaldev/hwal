...
Anchor program implementing the Chalna trigger engine on Solana.
...
The IDL is emitted to `target/idl/chalna.json` and a snapshot is kept at
[idl/chalna.json](idl/chalna.json) for client code generation.
